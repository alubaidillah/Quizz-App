...
const perintah = document.getElementById("ket");
...
function showScore(){
    ...
    questionElement.innerHTML = `Nilai kekuatan cintamu adalah: ${percent}%`;
    nextButton.innerHTML = "Play Again";
    nextButton.style.display = "block"
    perintah.innerHTML = "Begitulah kekuatan cinta berbicara"
}
